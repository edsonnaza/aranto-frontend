...
const SignUp: React.FC = () => {
  const [inputEntry, setInputEntry] = useState<user>(initValue);
  ...
  const handlerInput = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const checkInputEntry = (name: string, value: string) => {
      ...
      setInputError((prev) => {
        ...
        if (name === 'user_name') {
          if (value.length < 3) {
            newErrors.user_name = 'El nombre debe ser mínimo de 3 caracteres.';
          } else {
        ...
        if (name === 'user_lastname') {
          if (value.length < 3) {
            newErrors.user_lastname = 'El apellido debe ser mínimo de 3 caracteres.';
          } else {
            delete newErrors.user_lastname;
          }
        }
        ...
        if (name === 'password') {
          if (!passwordRegex.test(value)) {
            newErrors.password =
              'La contraseña debe tener al menos 6 caracteres, una letra mayúscula y un número o carácter especial.';
          } else {
    ...
    useEffect(() => {
      ...
      console.log("inputError keys:", Object.keys(inputError)); // Verifica en la consola
    ...
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-mx-auto border-stroke dark:border-strokedark lg:p-10 xl:p-8 xl:w-full xl:border-l-2">
            <div className="max-w-screen-sm mx-auto p-8 lg:p-10 xl:p-8 sm:w-full">
              <span className="mb-1.5 block font-medium">Registrarse</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Registro de nuevo usuario
              </h2>

              <form onSubmit={(event) => saveData(event, inputEntry)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {inputError.user_name && <p className='font-semibold text-red-500'>{inputError.user_name}</p>}
                  </div>
                </div>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                  ...
                  <div className="relative">
                    ...
                    {inputError.user_lastname && <p className='font-semibold text-red-500'>{inputError.user_lastname}</p>}
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {inputError.email && <p className='font-semibold text-red-500'>{inputError.email}</p>}
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      ...
                      {inputError.password && <p className='font-semibold text-red-500'>{inputError.password}</p>}
                  </div>
                </div>

                <div className="mb-6">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                    Re-escribir Contraseña
                  </label>
                  <div className="relative">
                    <input
                      type="password"
                      name='confirmPassword'
                      placeholder="Re-escribir su contraseña"
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      onChange={handlerInput}
                    />
                    ...
                    <span className="absolute right-4 top-4">
                      ...
                      {inputError.confirmPassword && <p  className='font-semibold text-red-500'>{inputError.confirmPassword}</p>}
                  </div>
                </div>
                ...
                <div className="mb-5">
                  <input
                    ...
                    disabled={!inputError || Object.keys(inputError).length > 0}
